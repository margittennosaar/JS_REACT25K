...
function logCarDetails(car) {
    const { brand = "Unknown Brand", year = "Unknown Year" } = car;
    console.log(`Car Brand: ${brand}, Year: ${year}`);
}

// Test Case
logCarDetails({ brand: "Toyota", year: 2020 });
// Expected Output: "Car Brand: Toyota, Year: 2020"

// Test with missing properties
logCarDetails({ brand: "Honda" });
// Expected Output: "Car Brand: Honda, Year: Unknown Year"

logCarDetails({});
// Expected Output: "Car Brand: Unknown Brand, Year: Unknown Year"
